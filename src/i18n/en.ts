...
`,
  ...
  orchestration: {
    plan: {
      description: 'Plan an orchestrated development workflow',
      tmuxRequired: 'mst plan requires tmux. Install with: brew install tmux',
      maestroExists: 'MAESTRO.yml already exists. Overwrite?',
      cancelled: 'Planning cancelled',
      describePrompt: 'Describe your orchestration plan:',
      featureHeader: 'Feature',
      featureName: 'Feature name (alphanumeric with dashes):',
      featureDescription: 'Feature description:',
      branchPrefix: 'Branch prefix (optional, e.g., "feature/"):',
      sessionCount: 'How many tmux sessions for this feature?',
      sessionName: 'Session name:',
      paneCount: 'Number of panes:',
      paneLayout: 'Pane layout:',
      panePrompt: 'Prompt for pane',
      addContext: 'Add Claude-specific context for this feature?',
      useAgents: 'Assign Claude agents to this feature?',
      addAnother: 'Add another feature?',
      configureSettings: 'Configure advanced settings?',
      savingMaestro: 'Saving MAESTRO.yml...',
      maestroSaved: 'MAESTRO.yml saved',
      planReady: 'Orchestration plan ready!',
      runImplement: 'Run "mst implement" to execute the plan',
    },
    implement: {
      description: 'Execute the orchestration plan from MAESTRO.yml',
      tmuxRequired: 'mst implement requires tmux. Install with: brew install tmux',
      notGitRepo: 'Not in a Git repository',
      loadingMaestro: 'Loading MAESTRO.yml...',
      invalidDeps: 'Invalid dependencies:',
      dryRun: 'Dry run mode - no changes will be made',
      executionOrder: 'Execution order:',
      wouldCreate: 'Would create:',
      startingOrchestration: 'Starting Orchestration...',
      creatingWorktrees: 'Creating worktrees...',
      worktreesCreated: 'Created {{count}} worktrees',
      installingDeps: 'Installing dependencies...',
      depsInstalled: 'Dependencies installed',
      creatingSession: 'Creating session {{name}}...',
      sessionsCreated: 'All tmux sessions created',
      orchestrationComplete: 'Orchestration Complete!',
      nextSteps: 'Next Steps:',
      attachSession: 'Attach to a session:',
      viewSessions: 'View all sessions:',
      viewStatus: 'See orchestration status:',
      promptsReady: 'Prompts are pre-filled in each pane. Press Enter to execute them.',
    },
    orchestra: {
      description: 'Manage and view orchestration status',
      tmuxRequired: 'tmux is required for this command',
      maestroNotFound: 'MAESTRO.yml not found',
      createPlan: 'Run "mst plan" to create an orchestration plan',
      maestroValid: 'MAESTRO.yml is valid',
      noImplementation: 'No orchestration has been implemented yet',
      runImplement: 'Run "mst implement" to execute your orchestration plan',
      orchestrationStatus: 'Orchestration Status',
      orchestratedSessions: 'Orchestrated Sessions',
      noActiveSessions: 'No active orchestrated sessions found',
      activeSessions: '{{count}} active sessions',
      attachWith: 'Attach with:',
      selectSession: 'Select session to attach:',
      attachingTo: 'Attaching to {{session}}...',
      noSessionsAvailable: 'No sessions available to attach',
    },
  },
